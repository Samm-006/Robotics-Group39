...
- **Controller:** [Group39_Integrated_System.py](https://github.com/Samm-006/Robotics-Group39/blob/main/controllers/Group39_Integrated_System.py)<br/>
	<sub>***Note:** Other existing controllers (.py files) shows individuals coding contribution on their assigned algorithms<br/>(*This is for contribution of integrated system purposes only*)</sub>
